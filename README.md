...
В процессе работы над проектом я активно использовал Perplexity Pro для поиска оптимальных решений, валидации архитектурных паттернов и анализа документации MagicOnion/gRPC.
...
- background-сервисы
- Структура папок
- Readme файл, с промптами на основе диалога с AI
